...
export class ImageListComponent implements OnInit, OnDestroy {
  ...
  public loadImages(): void {
    ...
    this._imageService.getAllImagesPaginated(page, size, sortBy, sortOrder).subscribe((response: ImagePageResponse) => {
      ...
      this.getImages.map((image) => this.getFileData(image.getFileUrl));
    });
  }
  ...
  public onImageUpdateClick(image: Image): void {
    this.setSelectedImage = image;
    this.toggleDialog(DialogType.ImageUpdate);
  }

  public onImageUpdated(): void {
    this.loadImages();
  }
  ...
  public onImageDeleteClick(image: Image): void {
    this.setSelectedImage = image;
    this.toggleDialog(DialogType.ImageDelete);
  }
