...
export class UserCreateRequest implements Serialize<object>, Deserialize<string> {
  ...
  toString(): string {
    return `UserCreateRequest [publicId=${this._publicId}, createdAt=${this._createdAt}, updatedAt=${this._updatedAt} name=${this._lastname}, firstname=${this._firstname}, email=${this._email}, password=${this._password}, role=${this._role}]`;
  }
}
